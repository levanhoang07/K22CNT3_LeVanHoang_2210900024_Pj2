...
namespace K22CNT3_LEVANHOANG_PROJECT2.Areas.AdminLVH.Controllers
{
    public class LVH_DonHangPj2Controller : Controller
    {
        private K22CNT3_LEVANHOANG_PROJECT2Entities db = new K22CNT3_LEVANHOANG_PROJECT2Entities();

        // GET: AdminLVH/LVH_DonHangPj2
        ...
        // GET: AdminLVH/LVH_DonHangPj2/Details/5
        ...
        // GET: AdminLVH/LVH_DonHangPj2/Create
        ...
        // POST: AdminLVH/LVH_DonHangPj2/Create
        ...
        // GET: AdminLVH/LVH_DonHangPj2/Edit/5
        ...
        // POST: AdminLVH/LVH_DonHangPj2/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AdminLVH/LVH_DonHangPj2/Delete/5
        ...
        // POST: AdminLVH/LVH_DonHangPj2/Delete/5
